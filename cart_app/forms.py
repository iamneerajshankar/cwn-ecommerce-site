...
from cart_app.models import Customer
...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(label='New Password', strip=False,
        help_text = password_validation.password_validators_help_text_html(), widget=forms.PasswordInput
...
class MyPasswordResetForm(PasswordResetForm):
    email = forms.EmailField(label='Email Address', max_length=254, widget=forms.EmailInput
